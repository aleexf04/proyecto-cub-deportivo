...
//     private JTextField txtDato1, txtDato2; // Servirán para Posicion/Dorsal o Especialidad/Exp
...
//         pnlGeneral.add(new JLabel("Username:")); txtUser = new JTextField(); pnlGeneral.add(txtUser);
//         pnlGeneral.add(new JLabel("Password:")); txtPass = new JPasswordField(); pnlGeneral.add(txtPass);
//         pnlGeneral.add(new JLabel("Email:")); txtEmail = new JTextField(); pnlGeneral.add(txtEmail);
//         pnlGeneral.add(new JLabel("Nombre:")); txtNombre = new JTextField(); pnlGeneral.add(txtNombre);
//         pnlGeneral.add(new JLabel("Apellidos:")); txtApellidos = new JTextField(); pnlGeneral.add(txtApellidos);
...
//         lblDato1 = new JLabel("Posición:"); txtDato1 = new JTextField();
//         lblDato2 = new JLabel("Dorsal:");   txtDato2 = new JTextField();
//         panelDinamico.add(lblDato1); panelDinamico.add(txtDato1);
//         panelDinamico.add(lblDato2); panelDinamico.add(txtDato2);
...
public class RegistroFrame extends JFrame{
    ...
    public RegistroFrame(){
        ...
        JPanel pnlGeneral = ew JPanel(new GridLayout(6,2,5,5));
        pnlGeneral.setBorder(BorderFactory.createTitledBorder("Datos de Usuario"));
        
        pnlGeneral.add(new JLabel("Usuario: "));
        txtUser = new JTextField();
        pnlGeneral.add(txtUser);
        pnlGeneral.add(new JLabel("Contraseña"));
        ...
        //Panel datos dependiendo de si es Jugador o Entrenador
        panelDinamico = new JPanel(new GridLayout(2,2,5,5));
        panelDinamico.setBorder(BorderFactory.createTitledBorder("Información específica"));
        ...
        private void registrar(){
            String rol = (String) comboRol.getSelectedIndex();
            boolean exito = false;
            ...
            if(rol.equals("Jugador")){
                ...
                rellenarDatosBase(ent);
                ent.setEspecialidad(txtDato1.getText());
                ent.setEspecialidad(Integer.parseInt(txtDato2.getText()));
                exito = usuarioDAO.registrarEntrenador(ent);
            }
